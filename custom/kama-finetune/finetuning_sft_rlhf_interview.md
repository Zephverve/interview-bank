---
title: 大模型微调面试怎么答？SFT、RLHF、DPO、PPO 到底还有没有必要？
round: 一面/二面
difficulty: ⭐⭐⭐
tags: [微调, 卡码笔记]
point: 大模型微调面试怎么答？SFT、RLHF、DPO、PPO 
source: 卡码笔记
sourceUrl: https://notes.kamacoder.com/interview/llm/finetuning_sft_rlhf_interview.html
---
...
**结论句（15 秒）**：基模越来越强，不是让 SFT、RLHF、RL 消失，而是让它们从&quot;补能力&quot;转向&quot;控行为、控偏好、控成本、控风险&quot;
...
**结论句（15 秒）**：因为这些概念经常被放在论文、训练框架、技术博客里讲，一上来就是 loss、reward、policy、KL penalty
...
**结论句（15 秒）**：RLHF 和 RL 的价值，也不能简单理解成&quot;让模型更聪明&quot;
...
**结论句（15 秒）**：DPO 现在经常被提到，是因为它工程上更轻
...
**结论句（15 秒）**：因为面试官不只想听你会做什么，也想看你知道什么时候不要做
...
**结论句（15 秒）**：面试里，如果你能讲到评估闭环，就比只会背概念强很多
...
**结论句（15 秒）**：&quot;基模能力越来越强，SFT/RLHF/RL 还有没有必要
