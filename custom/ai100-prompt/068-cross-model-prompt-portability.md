---
title: "跨模型 Prompt 迁移：如何编写模型无关的 Prompt？"
round: 一面/二面
difficulty: ⭐⭐⭐⭐
tags: [Prompt, AI100]
point: "Prompt Engineering"
source: Agent Interview 100
sourceUrl: https://github.com/BigKunLun/Agent-Interview-100/blob/main/07-prompt-engineering/068-cross-model-prompt-portability.md
---

**题目**：跨模型 Prompt 迁移：如何编写模型无关的 Prompt？
...
**追问方向**：误区："好的 Prompt 在所有模型上都好用" · 误区："只需要换 API endpoint 就能切换模型" · 追问："为什么企业需要多模型支持？"
