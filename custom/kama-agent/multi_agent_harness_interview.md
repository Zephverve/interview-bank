---
title: 未来的竞争，不是"谁的 Agent 更多"，而是"谁的 Harness 更稳"
round: 一面/二面
difficulty: ⭐⭐⭐
tags: [Agent, 卡码笔记]
point: 未来的竞争，不是"谁的 Agent 更多"，而是"谁的 
source: 卡码笔记
sourceUrl: https://notes.kamacoder.com/interview/llm/multi_agent_harness_interview.html
---
...
**结论句（15 秒）**：- 先说结论：生产级 Multi-Agent 拼的不是 Agent 数量
...
**结论句（15 秒）**：未来的竞争，不是谁的 Agent 更多，而是谁的 Harness 更稳
...
**结论句（15 秒）**：Harness 这个词，直译有&quot;挽具、束具、约束装置&quot;的意思
...
**结论句（15 秒）**：面试官问 Multi-Agent，不一定是想听你背框架 API
...
**结论句（15 秒）**：Multi-Agent 最常见的失败模式，不是 Agent 不够聪明
...
**结论句（15 秒）**：Multi-Agent 系统里，&quot;记忆&quot;这个词经常被浪漫化
...
**结论句（15 秒）**：Multi-Agent 系统的评估，是最容易被低估的环节
...
**结论句（15 秒）**：很多团队第一次跑通 Agent，最震惊的不是模型能力
...
**结论句（15 秒）**：MCP，也就是 Model Context Protocol，是现在 Agent 工具体系里很值得关注的方向
...
**结论句（15 秒）**：传统后端出问题，我们看日志、指标、链路追踪
