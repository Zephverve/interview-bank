---
title: Agent Skill 面试怎么答？如何写出高质量 Skill，真正提升 Age…
round: 一面/二面
difficulty: ⭐⭐⭐
tags: [Agent, 卡码笔记]
point: Agent Skill 面试怎么答？如何写出高质量 Sk
source: 卡码笔记
sourceUrl: https://notes.kamacoder.com/interview/llm/agent_skill_interview.html
---
...
**结论句（15 秒）**：- 先说结论：Skill 不是更长的 Prompt
...
**结论句（15 秒）**：Skill 不是更长的 Prompt，而是把可复用经验、操作流程、工具使用方法和质量标准沉淀成 Agent 可调用的能力模块
...
**结论句（15 秒）**：Skill 是面向某一类任务的可复用能力说明，它告诉 Agent 什么时候用、怎么做、用什么工具、按什么标准输出、遇到异常怎么处理
...
**结论句（15 秒）**：好的 Skill 不是坐在工位上拍脑袋写出来的
...
**结论句（15 秒）**：Skill 多了以后，最大的问题不是怎么写
...
**结论句（15 秒）**：面试里说 Skill，有一个很重要的加分点：
...
**结论句（15 秒）**：因为很多团队引入 Skill 后，确实会踩坑
