---
title: "高级 RAG 变体：Corrective RAG、Self-RAG、Adaptive…"
round: 一面/二面
difficulty: ⭐⭐⭐⭐
tags: [RAG, AI100]
point: "RAG"
source: Agent Interview 100
sourceUrl: https://github.com/BigKunLun/Agent-Interview-100/blob/main/02-rag/019-advanced-rag-variants.md
---

**题目**：高级 RAG 变体：Corrective RAG、Self-RAG、Adaptive RAG

**结论句（15 秒）**：三种高级 RAG 变体各解决不同问题：**Self-RAG** 通过反思 token 动态决定是否检索并自我评估输出质量，提升事实准确性；**Corrective RAG (CRAG)** 在检索后评估文档质量，对低质量结果触发 Web 搜索补救；**Adaptive RAG** 用分类器分析查询复杂度，动态路由到最合适的检索策略。三者可以组合使用，构成多层防御的高可靠 RAG 系统。

**追问方向**：误区："这些变体互相替代" · 误区："Self-RAG 可以用任何 LLM" · 追问："GraphRAG 属于哪个类别？"
