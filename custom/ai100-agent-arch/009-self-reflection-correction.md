---
title: "如何实现 Agent 的自我反思（Self-Reflection）和自我纠正？"
round: 一面/二面
difficulty: ⭐⭐⭐⭐
tags: [Agent, AI100]
point: "Agent 架构"
source: Agent Interview 100
sourceUrl: https://github.com/BigKunLun/Agent-Interview-100/blob/main/01-agent-architecture/009-self-reflection-correction.md
---

**题目**：如何实现 Agent 的自我反思（Self-Reflection）和自我纠正？

**结论句（15 秒）**：Agent 自我反思的核心框架是 Reflexion（Shinn et al., 2023），它将环境反馈转化为语言化的自我反思，存入长期记忆，供下一轮迭代参考——本质上是一种"语言化的强化学习"。除 Reflexion 外，还有 Self-Refine（迭代自我改进）、Self-Debug（自动调试代码）、Self-RAG（自我评估检索质量）等变体。关键争议在于：LLM 能否在没有外部反馈的情况下真正自我纠正推理？

**追问方向**：误区："让 LLM 反思就能提升效果" · 误区："反思越多轮越好" · 追问："Reflexion 的记忆如何管理？"
