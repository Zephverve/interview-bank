---
title: 字节跳动Agent开发四面面经：21道大模型面试题全解析，从Prompt到Age…
round: 一面/二面
difficulty: ⭐⭐⭐
tags: [面经, 卡码笔记]
point: 字节跳动Agent开发四面面经：21道大模型面试题全解析
source: 卡码笔记
sourceUrl: https://notes.kamacoder.com/interview/llm/20260506bytedance.html
---
...
**结论句（15 秒）**：### Prompt Engineering 的核心目标是什么
...
**结论句（15 秒）**：### 幻觉（Hallucination）是怎么产生的
...
**结论句（15 秒）**：### Agent 是如何结合工具、知识和规划自主运行的
...
**结论句（15 秒）**：### 微调（Fine-tuning）和 RAG 的使用场景有什么区别
...
**结论句（15 秒）**：### 项目中 Agent 的执行链路如何设计，如何保证连续任务的正确性
