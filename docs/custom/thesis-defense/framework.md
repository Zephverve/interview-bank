...
<div class="answer-dual" data-anchor="q01-什么是GTV-为什么题目要求分割GTV而不是CTV或PTV">
<div class="answer-mode-tabs">
<label class="answer-mode-btn answer-mode-left">
<input type="radio" name="mode-q01-什么是GTV-为什么题目要求分割GTV而不是CTV或PTV" value="recite" checked>
<span>📖 背诵用 · 通俗版</span>
</label>
<label class="answer-mode-btn answer-mode-right">
<input type="radio" name="mode-q01-什么是GTV-为什么题目要求分割GTV而不是CTV或PTV" value="interview">
<span>🎯 面试用 · 正式版</span>
</label>
</div>
<div class="answer-mode-panel answer-mode-recite">

GTV这个词听起来很专业，其实很简单——就是医生在CT片子上"肉眼能看到的肿瘤"。

放疗怎么画靶区呢？分三步，一层一层往外扩：
第一步，画GTV——就是你能看到的肿瘤本身。
第二步，在GTV外面再扩一圈，变成CTV。这一圈是为了覆盖"肉眼看不见但可能已经有癌细胞"的区域。
第三步，在CTV外面再扩一圈，变成PTV。这一圈是为了防止病人呼吸或者身体稍微动一下导致照射偏掉。

所以你看，GTV是最里面、最核心的。如果GTV画错了，外面扩多少圈都是错的。
题目只让我们分GTV，因为第一步走对了后面才能走对。
那CTV为什么不一起分呢？因为CTV里有"CT上根本看不到"的东西——癌细胞已经扩散了但影像上没显示。深度学习只能学"看得见"的东西，看不见的它学不了。
💡 一句话讲给外行听：GTV是你眼睛能看到的肿瘤，是画靶的第一步，也是一切的基础。
...
<div class="answer-dual" data-anchor="q02-为什么食管癌需要分型-不同分型之间到底有什么差异">
<div class="answer-mode-tabs">
<label class="answer-mode-btn answer-mode-left">
<input type="radio" name="mode-q02-为什么食管癌需要分型-不同分型之间到底有什么差异" value="recite" checked>
<span>📖 背诵用 · 通俗版</span>
</label>
<label class="answer-mode-btn answer-mode-right">
<input type="radio" name="mode-q02-为什么食管癌需要分型-不同分型之间到底有什么差异" value="interview">
<span>🎯 面试用 · 正式版</span>
</label>
</div>
<div class="answer-mode-panel answer-mode-recite">
...
<div class="answer-dual" data-anchor="q03-为什么最终把临床六分型归并为三类-依据是什么">
<div class="answer-mode-tabs">
<label class="answer-mode-btn answer-mode-left">
<input type="radio" name="mode-q03-为什么最终把临床六分型归并为三类-依据是什么" value="recite" checked>
<span>📖 背诵用 · 通俗版</span>
</label>
<label class="answer-mode-btn answer-mode-right">
<input type="radio" name="mode-q03-为什么最终把临床六分型归并为三类-依据是什么" value="interview">
<span>🎯 面试用 · 正式版</span>
</label>
</div>
<div class="answer-mode-panel answer-mode-recite">
...
<div class="answer-dual" data-anchor="q04-论文的三个问题之间是什么关系-整体技术路线是怎样的">
<div class="answer-mode-tabs">
<label class="answer-mode-btn answer-mode-left">
<input type="radio" name="mode-q04-论文的三个问题之间是什么关系-整体技术路线是怎样的" value="recite" checked>
<span>📖 背诵用 · 通俗版</span>
</label>
<label class="answer-mode-btn answer-mode-right">
<input type="radio" name="mode-q04-论文的三个问题之间是什么关系-整体技术路线是怎样的" value="interview">
<span>🎯 面试用 · 正式版</span>
</label>
</div>
<div class="answer-mode-panel answer-mode-recite">
...
问题一 = 打地基。把乱七八糟的原始CT数据洗干净、格式统一，同时分析一下肿瘤长得有什么规律。
问题二 = 选方案盖楼。我们做了A/B/C/D四种方案，一个个试，看哪个最好。
问题三 = 交钥匙验收。用选出来的最好的方案，对全新的病人数据做预测。

这三个问题是一个完整的链条：地基打不牢→楼盖不好。方案没选对→验收过不了关。
💡 三个字：洗→选→交。洗数据、选方案、交结果。
...
<div class="answer-dual" data-anchor="q05-为什么从数据预处理入手-而不是直接上模型">
<div class="answer-mode-tabs">
<label class="answer-mode-btn answer-mode-left">
<input type="radio" name="mode-q05-为什么从数据预处理入手-而不是直接上模型" value="recite" checked>
<span>📖 背诵用 · 通俗版</span>
</label>
<label class="answer-mode-btn answer-mode-right">
<input type="radio" name="mode-q05-为什么从数据预处理入手-而不是直接上模型" value="interview">
<span>🎯 面试用 · 正式版</span>
</label>
</div>
<div class="answer-mode-panel answer-mode-recite">
...
<div class="answer-dual" data-anchor="q06-整篇论文最重要的技术决策有哪些">
<div class="answer-mode-tabs">
<label class="answer-mode-btn answer-mode-left">
<input type="radio" name="mode-q06-整篇论文最重要的技术决策有哪些" value="recite" checked>
<span>📖 背诵用 · 通俗版</span>
</label>
<label class="answer-mode-btn answer-mode-right">
<input type="radio" name="mode-q06-整篇论文最重要的技术决策有哪些" value="interview">
<span>🎯 面试用 · 正式版</span>
</label>
</div>
<div class="answer-mode-panel answer-mode-recite">
...
<div class="answer-dual" data-anchor="q08-论文为什么不把策略A-B-C-D的命名理清楚-它们的设计逻辑是什么">
<div class="answer-mode-tabs">
<label class="answer-mode-btn answer-mode-left">
<input type="radio" name="mode-q08-论文为什么不把策略A-B-C-D的命名理清楚-它们的设计逻辑是什么" value="recite" checked>
<span>📖 背诵用 · 通俗版</span>
</label>
<label class="answer-mode-btn answer-mode-right">
<input type="radio" name="mode-q08-论文为什么不把策略A-B-C-D的命名理清楚-它们的设计逻辑是什么" value="interview">
<span>🎯 面试用 · 正式版</span>
</label>
</div>
<div class="answer-mode-panel answer-mode-recite">
