...
<p class="part-desc">ReAct · Agent Loop · 生产架构 · 共 10 题</p>
...
📝 **本分类源文件**：`custom/ai100-agent-arch/` · 新增题目后运行 `npm run prepare` 即可刷新。

</div>

<div class="question-card compact-card" id="001-what-is-llm-agent-1">
...
<div class="question-card compact-card" id="001-what-is-llm-agent-2">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span><span class="question-text">代码示例</span></h2>
...
<div class="question-card compact-card" id="001-what-is-llm-agent-3">
...
<div class="question-card compact-card" id="001-what-is-llm-agent-4">
...
<div class="question-card compact-card" id="002-agent-core-components-1">
...
<div class="question-card compact-card" id="002-agent-core-components-2">
...
<div class="question-card compact-card" id="002-agent-core-components-3">
...
<div class="question-card compact-card" id="003-agent-architecture-patterns-1">
...
<div class="question-card compact-card" id="003-agent-architecture-patterns-2">
...
<div class="question-card compact-card" id="003-agent-architecture-patterns-3">
...
<div class="question-card compact-card" id="005-layered-agent-architecture-1">
...
<div class="question-card compact-card" id="005-layered-agent-architecture-2">
...
<div class="question-card compact-card" id="005-layered-agent-architecture-3">
...
<div class="question-card compact-card" id="006-agent-loop-and-error-recovery-1">
...
<div class="question-card compact-card" id="006-agent-loop-and-error-recovery-2">
...
<div class="question-card compact-card" id="006-agent-loop-and-error-recovery-3">
...
<div class="question-card compact-card" id="007-workflow-vs-agent-1">
...
<div class="question-card compact-card" id="007-workflow-vs-agent-2">
...
<div class="question-card compact-card" id="007-workflow-vs-agent-3">
...
<div class="question-card compact-card" id="009-self-reflection-correction-1">
...
<div class="question-card compact-card" id="009-self-reflection-correction-2">
...
<div class="question-card compact-card" id="009-self-reflection-correction-3">
...
<div class="question-card compact-card" id="010-production-agent-system-design-1">
...
<div class="question-card compact-card" id="010-production-agent-system-design-2">
...
<div class="question-card compact-card" id="010-production-agent-system-design-3">
...
<div class="question-card compact-card" id="108-interview-deep-dive-chain-1">
...
<div class="question-card compact-card" id="108-interview-deep-dive-chain-2">
...
<div class="question-card compact-card" id="108-interview-deep-dive-chain-3">
...
<div class="question-card compact-card" id="109-what-is-agent-harness-1">
...
<div class="question-card compact-card" id="109-what-is-agent-harness-2">
...
<div class="question-card compact-card" id="109-what-is-agent-harness-3">
