---
custom: true
partTitle: AI100 · 安全对齐
partColor: #ef4444
---

<div class="part-hero custom-hero" style="--part-color: #ef4444">

# 🛡️ AI100 · 安全对齐

<p class="part-desc">Guardrails · 沙箱 · 红队 · 共 8 题</p>
...
📝 **本分类源文件**：`custom/ai100-safety/` · 新增题目后运行 `npm run prepare` 即可刷新。

</div>

<div class="question-card compact-card" id="078-agent-safety-risks-1">
...
<div class="question-card compact-card" id="078-agent-safety-risks-2">
...
<div class="question-card compact-card" id="078-agent-safety-risks-3">
...
<div class="question-card compact-card" id="079-guardrails-basics-1">
...
<div class="question-card compact-card" id="079-guardrails-basics-2">
...
<div class="question-card compact-card" id="079-guardrails-basics-3">
...
<div class="question-card compact-card" id="080-human-in-the-loop-1">
...
<div class="question-card compact-card" id="080-human-in-the-loop-2">
...
<div class="question-card compact-card" id="080-human-in-the-loop-3">
...
<div class="question-card compact-card" id="081-least-privilege-sandboxing-1">
...
<div class="question-card compact-card" id="081-least-privilege-sandboxing-2">
...
<div class="question-card compact-card" id="081-least-privilege-sandboxing-3">
...
<div class="question-card compact-card" id="082-hallucination-detection-1">
...
<div class="question-card compact-card" id="082-hallucination-detection-2">
...
<div class="question-card compact-card" id="082-hallucination-detection-3">
...
<div class="question-card compact-card" id="083-content-filtering-toxicity-1">
...
<div class="question-card compact-card" id="083-content-filtering-toxicity-2">
...
<div class="question-card compact-card" id="083-content-filtering-toxicity-3">
...
<div class="question-card compact-card" id="084-agent-alignment-1">
...
<div class="question-card compact-card" id="084-agent-alignment-2">
...
<div class="question-card compact-card" id="084-agent-alignment-3">
...
<div class="question-card compact-card" id="085-red-teaming-agents-1">
...
<div class="question-card compact-card" id="085-red-teaming-agents-2">
...
<div class="question-card compact-card" id="085-red-teaming-agents-3">
