...
<div class="question-card custom-card" id="a2a_protocol">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 什么是 A2A 协议？它和 MCP 协议的区别是什么？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：工具调用, MCP, 小林笔记 · 考察点：什么是 A2A 协议？它和 MCP 协议的区别是什么？</div>

<div class="question-prompt"><strong>题目</strong>：什么是 A2A 协议？它和 MCP 协议的区别是什么？</div>


<div class="q-conclusion">

💡 **15 秒结论**：A2A 是 Google 发布的开放协议，专门解决多个 AI Agent 之间怎么互相通信协作的问题
...
<div class="question-card custom-card" id="fc_skill_mcp">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> Function Calling、Skill、MCP 这三个有什么区别？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：工具调用, MCP, 小林笔记 · 考察点：Function Calling、Skill、MCP 这三个</div>

<div class="question-prompt"><strong>题目</strong>：Function Calling、Skill、MCP 这三个有什么区别？</div>


<div class="q-conclusion">

💡 **15 秒结论**：这三个概念在不同层次工作，不是竞争关系
...
<div class="question-card custom-card" id="fc_training">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 大模型的 Function Call 能力是怎么训练出来的？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：工具调用, MCP, 小林笔记 · 考察点：大模型的 Function Call 能力是怎么训练出来的？</div>

<div class="question-prompt"><strong>题目</strong>：大模型的 Function Call 能力是怎么训练出来的？</div>


<div class="q-conclusion">

💡 **15 秒结论**：Function Call 的能力主要靠两个训练阶段来培养，这两个阶段解决的是不同的问题
...
<div class="question-card custom-card" id="fc_vs_mcp_usage">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> Function Calling 也属于工具调用，请问什么场景下使用 Funct…</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：工具调用, MCP, 小林笔记 · 考察点：Function Calling 也属于工具调用，请问什么场</div>

<div class="question-prompt"><strong>题目</strong>：Function Calling 也属于工具调用，请问什么场景下使用 Function Calling，什么场景下使用 MCP？</div>


<div class="q-conclusion">

💡 **15 秒结论**：如果只是给单个应用接一两个工具、场景临时、不需要复用，Function Calling 就够了，简单直接，不需要引入额外的进程和配置
...
<div class="question-card custom-card" id="function_calling">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 什么是 Function Calling ？原理是什么？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：工具调用, MCP, 小林笔记 · 考察点：什么是 Function Calling ？原理是什么？</div>

<div class="question-prompt"><strong>题目</strong>：什么是 Function Calling ？原理是什么？</div>


<div class="q-conclusion">

💡 **15 秒结论**：Function Calling 我的理解是这样一套机制：开发者用 JSON schema 把工具描述好传给模型，模型判断需要调工具的时候不输出自然语言，而是直接输出一段结构化的 tool_calls JSON，告诉你「我要调哪个函数、参数…
...
<div class="question-card custom-card" id="llm_gateway">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 有没有用过大模型的网关框架？网关层解决了什么问题？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：工具调用, MCP, 小林笔记 · 考察点：有没有用过大模型的网关框架？网关层解决了什么问题？</div>

<div class="question-prompt"><strong>题目</strong>：有没有用过大模型的网关框架？网关层解决了什么问题？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我用过 LiteLLM，它是目前最活跃的开源 LLM 网关
...
<div class="question-card custom-card" id="llm_tool_learning">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> LLM 是如何学会调用外部工具的？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：工具调用, MCP, 小林笔记 · 考察点：LLM 是如何学会调用外部工具的？</div>

<div class="question-prompt"><strong>题目</strong>：LLM 是如何学会调用外部工具的？</div>


<div class="q-conclusion">

💡 **15 秒结论**：这道题我分两块来讲：模型怎么被训练出工具调用能力，以及训练好之后运行时是怎么工作的
...
<div class="question-card custom-card" id="mcp_components">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> MCP 由哪几部分组成？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：工具调用, MCP, 小林笔记 · 考察点：MCP 由哪几部分组成？</div>

<div class="question-prompt"><strong>题目</strong>：MCP 由哪几部分组成？</div>


<div class="q-conclusion">

💡 **15 秒结论**：MCP 由三层组成，可以从角色、能力、协议三个维度来理解
...
<div class="question-card custom-card" id="mcp_transport">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> MCP 协议通常采用什么通信方式？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：工具调用, MCP, 小林笔记 · 考察点：MCP 协议通常采用什么通信方式？</div>

<div class="question-prompt"><strong>题目</strong>：MCP 协议通常采用什么通信方式？</div>


<div class="q-conclusion">

💡 **15 秒结论**：MCP 支持两种主要的传输方式，分别适用于不同场景
...
<div class="question-card custom-card" id="mcp_vs_fc">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> MCP 和 Function Calling 有什么区别？有没有实际跑过 MCP…</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：工具调用, MCP, 小林笔记 · 考察点：MCP 和 Function Calling 有什么区别？有</div>

<div class="question-prompt"><strong>题目</strong>：MCP 和 Function Calling 有什么区别？有没有实际跑过 MCP？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解这两者不是竞争关系，解决的不是同一层面的问题
...
<div class="question-card" id="mcp_vs_skill-1">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 第一步：读取待审查的代码文件</h2>
...
<div class="question-card" id="mcp_vs_skill-2">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 第二步：执行安全检查</h2>
...
<div class="question-card" id="mcp_vs_skill-3">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 第三步：输出审查报告</h2>
...
<div class="question-card custom-card" id="reasoning_no_mcp">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 为什么有些特定的推理模型不支持 MCP 协议？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：工具调用, MCP, 小林笔记 · 考察点：为什么有些特定的推理模型不支持 MCP 协议？</div>

<div class="question-prompt"><strong>题目</strong>：为什么有些特定的推理模型不支持 MCP 协议？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解根本原因是两者的生成范式有冲突
...
<div class="question-card" id="skill-1">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 指令</h2>
...
<div class="question-card custom-card" id="sse_vs_websocket">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 说说 WebSocket 和 SSE 通信的区别及局限性？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：工具调用, MCP, 小林笔记 · 考察点：说说 WebSocket 和 SSE 通信的区别及局限性？</div>

<div class="question-prompt"><strong>题目</strong>：说说 WebSocket 和 SSE 通信的区别及局限性？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我觉得最核心的区别是通信方向：SSE 是服务端单向推，客户端只能接收，想发消息只能另起一个 HTTP 请求；WebSocket 是全双工，双方都可以随时主动发消息
...
<div class="question-card custom-card" id="webrtc_vs_ws">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 为什么要用 WebRTC 协议？它和 WebSocket（WS）在 AI 对话流…</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：工具调用, MCP, 小林笔记 · 考察点：为什么要用 WebRTC 协议？它和 WebSocket（W</div>

<div class="question-prompt"><strong>题目</strong>：为什么要用 WebRTC 协议？它和 WebSocket（WS）在 AI 对话流中的核心差异是什么？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解核心原因是 WebSocket 基于 TCP，而 TCP 的可靠性设计在实时语音场景里反而是负担
...
<div class="question-card custom-card" id="what_is_mcp">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 什么是 MCP（模型上下文协议）？讲讲它的核心内容？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：工具调用, MCP, 小林笔记 · 考察点：什么是 MCP（模型上下文协议）？讲讲它的核心内容？</div>

<div class="question-prompt"><strong>题目</strong>：什么是 MCP（模型上下文协议）？讲讲它的核心内容？</div>


<div class="q-conclusion">

💡 **15 秒结论**：MCP 是 Anthropic 在 2024 年底推出的开放协议，我理解它主要解决的是「模型接工具太碎片化」的问题
