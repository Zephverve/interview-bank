...
<div class="question-card custom-card" id="components">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> Agent 的基本架构由哪些核心组件构成？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：Agent, 小林笔记 · 考察点：Agent 的基本架构由哪些核心组件构成？</div>

<div class="question-prompt"><strong>题目</strong>：Agent 的基本架构由哪些核心组件构成？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解 Agent 的基本架构有四个核心组件：LLM、工具、记忆、规划模块
...
<div class="question-card custom-card" id="handcode">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 在工程实践中，为什么有时候选择「手搓」Agent，而不是直接用成熟框架？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：Agent, 小林笔记 · 考察点：在工程实践中，为什么有时候选择「手搓」Agent，而不是直接</div>

<div class="question-prompt"><strong>题目</strong>：在工程实践中，为什么有时候选择「手搓」Agent，而不是直接用成熟框架？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我的感受是框架用起来快，但有几个实际痛点
...
<div class="question-card custom-card" id="memcompress">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> Agent 记忆压缩通常有哪些方法？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：Agent, 小林笔记 · 考察点：Agent 记忆压缩通常有哪些方法？</div>

<div class="question-prompt"><strong>题目</strong>：Agent 记忆压缩通常有哪些方法？</div>


<div class="q-conclusion">

💡 **15 秒结论**：记忆压缩常见有四种方法：摘要压缩、滑动窗口、重要性过滤、结构化抽取
...
<div class="question-card custom-card" id="memory">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 请你介绍一下 AI Agent 的记忆机制，并说明在实际开发中应该如何设计记忆模…</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：Agent, 小林笔记 · 考察点：请你介绍一下 AI Agent 的记忆机制，并说明在实际开发</div>

<div class="question-prompt"><strong>题目</strong>：请你介绍一下 AI Agent 的记忆机制，并说明在实际开发中应该如何设计记忆模块？</div>


<div class="q-conclusion">

💡 **15 秒结论**：Agent 需要记忆才能在多步任务中保持状态、跨任务积累知识
...
<div class="question-card custom-card" id="memory_storage">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> Agent 的长短期记忆系统怎么做的？记忆是怎么存的？粒度是多少？怎么用的？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：Agent, 小林笔记 · 考察点：Agent 的长短期记忆系统怎么做的？记忆是怎么存的？粒度是</div>

<div class="question-prompt"><strong>题目</strong>：Agent 的长短期记忆系统怎么做的？记忆是怎么存的？粒度是多少？怎么用的？</div>


<div class="q-conclusion">

💡 **15 秒结论**：短期记忆就是 context window 里的对话历史，存当前任务的中间状态，任务结束就清掉；长期记忆用向量数据库存，把信息 embedding 后写入，用的时候做语义检索拿回来注入 prompt
...
<div class="question-card custom-card" id="multiagent">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 什么是 Multi-Agent？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：Agent, 小林笔记 · 考察点：什么是 Multi-Agent？</div>

<div class="question-prompt"><strong>题目</strong>：什么是 Multi-Agent？</div>


<div class="q-conclusion">

💡 **15 秒结论**：多智能体系统（Multi-Agent）就是多个 Agent 协作完成任务，每个 Agent 各有分工，有的负责搜索、有的负责写代码、有的负责做评审
...
<div class="question-card custom-card" id="patterns">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 了解哪些其他的 Agent 设计范式？Agent 和 Workflow的区别是什…</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：Agent, 小林笔记 · 考察点：了解哪些其他的 Agent 设计范式？Agent 和 Wor</div>

<div class="question-prompt"><strong>题目</strong>：了解哪些其他的 Agent 设计范式？Agent 和 Workflow的区别是什么？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解 Agent 和 Workflow 最核心的区别是「谁来决定下一步」
...
<div class="question-card custom-card" id="planning">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 如何赋予 LLM 规划能力？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：Agent, 小林笔记 · 考察点：如何赋予 LLM 规划能力？</div>

<div class="question-prompt"><strong>题目</strong>：如何赋予 LLM 规划能力？</div>


<div class="q-conclusion">

💡 **15 秒结论**：给 LLM 加规划能力主要靠这几种思路
...
<div class="question-card custom-card" id="react">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> Agent 推理模式有哪些？ReAct 是啥？具体是怎么实现的？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：Agent, 小林笔记 · 考察点：Agent 推理模式有哪些？ReAct 是啥？具体是怎么实现</div>

<div class="question-prompt"><strong>题目</strong>：Agent 推理模式有哪些？ReAct 是啥？具体是怎么实现的？</div>


<div class="q-conclusion">

💡 **15 秒结论**：Agent 的推理模式我用过几种
...
<div class="question-card custom-card" id="reflection">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 讲讲 Agent 的反思机制？为什么要用反思？具体怎么实现？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：Agent, 小林笔记 · 考察点：讲讲 Agent 的反思机制？为什么要用反思？具体怎么实现？</div>

<div class="question-prompt"><strong>题目</strong>：讲讲 Agent 的反思机制？为什么要用反思？具体怎么实现？</div>


<div class="q-conclusion">

💡 **15 秒结论**：反思机制我的理解是：让 Agent 在完成一个步骤或整个任务后，自我评估输出质量，判断有没有问题，不达标就重试或调整策略
...
<div class="question-card custom-card" id="single_multi">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 说说 Single-Agent 和 Multi-Agent 的设计方案？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：Agent, 小林笔记 · 考察点：说说 Single-Agent 和 Multi-Agent</div>

<div class="question-prompt"><strong>题目</strong>：说说 Single-Agent 和 Multi-Agent 的设计方案？</div>


<div class="q-conclusion">

💡 **15 秒结论**：Single-Agent 适合任务流程清晰、复杂度适中的场景，实现简单、好维护；Multi-Agent 适合需要专业分工、任务量大或者需要并行执行的复杂场景
...
<div class="question-card custom-card" id="tasksplit">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 复杂任务怎么做的任务拆分？为什么要拆分？效果如何提升？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：Agent, 小林笔记 · 考察点：复杂任务怎么做的任务拆分？为什么要拆分？效果如何提升？</div>

<div class="question-prompt"><strong>题目</strong>：复杂任务怎么做的任务拆分？为什么要拆分？效果如何提升？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解任务拆分的原因是 LLM 一次性处理太复杂的任务很容易出错，把大任务拆成小步骤，每步聚焦一件事，准确率会明显提升
...
<div class="question-card custom-card" id="three_patterns">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> ReAct、Plan-and-Execute、Reflection 三种范式有什…</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：Agent, 小林笔记 · 考察点：ReAct、Plan-and-Execute、Reflect</div>

<div class="question-prompt"><strong>题目</strong>：ReAct、Plan-and-Execute、Reflection 三种范式有什么核心区别？实际项目中该如何选型？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解这三者是 Agent 开发里最主流的三种设计范式，核心区别在于「决策和执行的关系」
...
<div class="question-card custom-card" id="whatisagent">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 什么是 Agent？与大模型有什么本质不同？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：Agent, 小林笔记 · 考察点：什么是 Agent？与大模型有什么本质不同？</div>

<div class="question-prompt"><strong>题目</strong>：什么是 Agent？与大模型有什么本质不同？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解 Agent 本质上是一个能自主完成目标的 AI 系统，跟传统 AI 最核心的区别在于「自主性」和「能行动」
...
<div class="question-card custom-card" id="workflow_tools">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> Workflow，Agent，Tools 这三个的概念和区别介绍一下？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：Agent, 小林笔记 · 考察点：Workflow，Agent，Tools 这三个的概念和区别</div>

<div class="question-prompt"><strong>题目</strong>：Workflow，Agent，Tools 这三个的概念和区别介绍一下？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解这三个概念是粒度从小到大的三层结构
