---
custom: true
partTitle: AI100 · 记忆与状态
partColor: #a855f7
---

<div class="part-hero custom-hero" style="--part-color: #a855f7">

# 🧠 AI100 · 记忆与状态

<p class="part-desc">短期/长期记忆 · 上下文管理 · 共 7 题</p>
...
📝 **本分类源文件**：`custom/ai100-memory/` · 新增题目后运行 `npm run prepare` 即可刷新。

</div>

<div class="question-card compact-card" id="040-memory-types-1">
...
<div class="question-card compact-card" id="040-memory-types-2">
...
<div class="question-card compact-card" id="040-memory-types-3">
...
<div class="question-card compact-card" id="041-context-window-management-1">
...
<div class="question-card compact-card" id="041-context-window-management-2">
...
<div class="question-card compact-card" id="041-context-window-management-3">
...
<div class="question-card compact-card" id="043-persistent-memory-1">
...
<div class="question-card compact-card" id="043-persistent-memory-2">
...
<div class="question-card compact-card" id="043-persistent-memory-3">
...
<div class="question-card compact-card" id="044-state-management-patterns-1">
...
<div class="question-card compact-card" id="044-state-management-patterns-2">
...
<div class="question-card compact-card" id="044-state-management-patterns-3">
...
<div class="question-card compact-card" id="045-cross-session-preferences-1">
...
<div class="question-card compact-card" id="045-cross-session-preferences-2">
...
<div class="question-card compact-card" id="045-cross-session-preferences-3">
...
<div class="question-card compact-card" id="046-long-term-memory-storage-1">
...
<div class="question-card compact-card" id="046-long-term-memory-storage-2">
...
<div class="question-card compact-card" id="046-long-term-memory-storage-3">
...
<div class="question-card compact-card" id="048-memory-forgetting-updating-1">
...
<div class="question-card compact-card" id="048-memory-forgetting-updating-2">
...
<div class="question-card compact-card" id="048-memory-forgetting-updating-3">
