...
<p class="part-desc">分块 · 检索 · Agentic RAG · 评估 · 共 9 题</p>
...
📝 **本分类源文件**：`custom/ai100-rag/` · 新增题目后运行 `npm run prepare` 即可刷新。

</div>

<div class="question-card compact-card" id="011-rag-overview-and-pipeline-1">
...
<div class="question-card compact-card" id="011-rag-overview-and-pipeline-2">
...
<div class="question-card compact-card" id="011-rag-overview-and-pipeline-3">
...
<div class="question-card compact-card" id="013-chunking-strategies-1">
...
<div class="question-card compact-card" id="013-chunking-strategies-2">
...
<div class="question-card compact-card" id="013-chunking-strategies-3">
...
<div class="question-card compact-card" id="014-vector-database-comparison-1">
...
<div class="question-card compact-card" id="014-vector-database-comparison-2">
...
<div class="question-card compact-card" id="014-vector-database-comparison-3">
...
<div class="question-card compact-card" id="015-embedding-model-selection-1">
...
<div class="question-card compact-card" id="015-embedding-model-selection-2">
...
<div class="question-card compact-card" id="015-embedding-model-selection-3">
...
<div class="question-card compact-card" id="016-hybrid-retrieval-1">
...
<div class="question-card compact-card" id="016-hybrid-retrieval-2">
...
<div class="question-card compact-card" id="016-hybrid-retrieval-3">
...
<div class="question-card compact-card" id="017-reranking-strategies-1">
...
<div class="question-card compact-card" id="017-reranking-strategies-2">
...
<div class="question-card compact-card" id="017-reranking-strategies-3">
...
<div class="question-card compact-card" id="018-agentic-rag-1">
...
<div class="question-card compact-card" id="018-agentic-rag-2">
...
<div class="question-card compact-card" id="018-agentic-rag-3">
...
<div class="question-card compact-card" id="019-advanced-rag-variants-1">
...
<div class="question-card compact-card" id="019-advanced-rag-variants-2">
...
<div class="question-card compact-card" id="019-advanced-rag-variants-3">
...
<div class="question-card custom-card compact-card" id="020-rag-evaluation-metrics">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span><span class="question-text">RAG 评估指标体系：原理、计算与实战</span></h2>
