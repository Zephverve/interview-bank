...
<p class="part-desc">LLMOps · 成本 · 监控 · 扩缩容 · 共 12 题</p>
...
📝 **本分类源文件**：`custom/ai100-production/` · 新增题目后运行 `npm run prepare` 即可刷新。

</div>

<div class="question-card compact-card" id="086-llmops-and-deployment-1">
...
<div class="question-card compact-card" id="086-llmops-and-deployment-2">
...
<div class="question-card compact-card" id="086-llmops-and-deployment-3">
...
<div class="question-card compact-card" id="088-cost-optimization-1">
...
<div class="question-card compact-card" id="088-cost-optimization-2">
...
<div class="question-card compact-card" id="088-cost-optimization-3">
...
<div class="question-card compact-card" id="089-model-routing-1">
...
<div class="question-card compact-card" id="089-model-routing-2">
...
<div class="question-card compact-card" id="089-model-routing-3">
...
<div class="question-card compact-card" id="090-latency-optimization-1">
...
<div class="question-card compact-card" id="090-latency-optimization-2">
...
<div class="question-card compact-card" id="090-latency-optimization-3">
...
<div class="question-card compact-card" id="091-prompt-drift-management-1">
...
<div class="question-card compact-card" id="091-prompt-drift-management-2">
...
<div class="question-card compact-card" id="091-prompt-drift-management-3">
...
<div class="question-card compact-card" id="092-logging-monitoring-alerting-1">
...
<div class="question-card compact-card" id="092-logging-monitoring-alerting-2">
...
<div class="question-card compact-card" id="092-logging-monitoring-alerting-3">
...
<div class="question-card compact-card" id="093-canary-ab-testing-1">
...
<div class="question-card compact-card" id="093-canary-ab-testing-2">
...
<div class="question-card compact-card" id="093-canary-ab-testing-3">
...
<div class="question-card compact-card" id="094-scaling-strategies-1">
...
<div class="question-card compact-card" id="094-scaling-strategies-2">
...
<div class="question-card compact-card" id="094-scaling-strategies-3">
...
<div class="question-card compact-card" id="095-disaster-recovery-ha-1">
...
<div class="question-card compact-card" id="095-disaster-recovery-ha-2">
...
<div class="question-card compact-card" id="095-disaster-recovery-ha-3">
...
<div class="question-card compact-card" id="104-agent-production-troubleshooting-1">
...
<div class="question-card compact-card" id="104-agent-production-troubleshooting-2">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span><span class="question-text">参考资料（必须优先基于以下内容回答，不得编造未提及的信息）</span></h2>
...
<div class="question-card compact-card" id="104-agent-production-troubleshooting-3">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span><span class="question-text">对话历史</span></h2>
...
<div class="question-card compact-card" id="104-agent-production-troubleshooting-4">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span><span class="question-text">当前问题</span></h2>
...
<div class="question-card compact-card" id="104-agent-production-troubleshooting-5">
...
<div class="question-card compact-card" id="104-agent-production-troubleshooting-6">
...
<div class="question-card compact-card" id="107-agent-code-review-1">
...
<div class="question-card compact-card" id="107-agent-code-review-2">
...
<div class="question-card compact-card" id="107-agent-code-review-3">
...
<div class="question-card compact-card" id="112-agent-sandbox-runtime-1">
...
<div class="question-card compact-card" id="112-agent-sandbox-runtime-2">
...
<div class="question-card compact-card" id="112-agent-sandbox-runtime-3">
