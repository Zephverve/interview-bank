...
<p class="part-desc">Agent 评测 · Benchmark · 指标 · 共 9 题</p>
...
📝 **本分类源文件**：`custom/ai100-evaluation/` · 新增题目后运行 `npm run prepare` 即可刷新。

</div>

<div class="question-card compact-card" id="069-evaluation-methodology-1">
...
<div class="question-card compact-card" id="069-evaluation-methodology-2">
...
<div class="question-card compact-card" id="069-evaluation-methodology-3">
...
<div class="question-card compact-card" id="071-llm-as-judge-1">
...
<div class="question-card compact-card" id="071-llm-as-judge-2">
...
<div class="question-card compact-card" id="071-llm-as-judge-3">
...
<div class="question-card compact-card" id="072-agent-benchmarks-1">
...
<div class="question-card compact-card" id="072-agent-benchmarks-2">
...
<div class="question-card compact-card" id="072-agent-benchmarks-3">
...
<div class="question-card compact-card" id="073-regression-testing-1">
...
<div class="question-card compact-card" id="073-regression-testing-2">
...
<div class="question-card compact-card" id="073-regression-testing-3">
...
<div class="question-card compact-card" id="074-traces-and-spans-1">
...
<div class="question-card compact-card" id="074-traces-and-spans-2">
...
<div class="question-card compact-card" id="074-traces-and-spans-3">
...
<div class="question-card compact-card" id="075-evaluation-tools-comparison-1">
...
<div class="question-card compact-card" id="075-evaluation-tools-comparison-2">
...
<div class="question-card compact-card" id="075-evaluation-tools-comparison-3">
...
<div class="question-card compact-card" id="076-static-benchmark-trap-1">
...
<div class="question-card compact-card" id="076-static-benchmark-trap-2">
...
<div class="question-card compact-card" id="076-static-benchmark-trap-3">
...
<div class="question-card compact-card" id="077-continuous-evaluation-pipeline-1">
...
<div class="question-card compact-card" id="077-continuous-evaluation-pipeline-2">
...
<div class="question-card compact-card" id="077-continuous-evaluation-pipeline-3">
...
<div class="question-card compact-card" id="111-eval-harness-design-1">
...
<div class="question-card compact-card" id="111-eval-harness-design-2">
...
<div class="question-card compact-card" id="111-eval-harness-design-3">
