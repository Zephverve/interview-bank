...
<p class="part-desc">协作 · 通信 · 编排 · 共 10 题</p>
...
📝 **本分类源文件**：`custom/ai100-multi-agent/` · 新增题目后运行 `npm run prepare` 即可刷新。

</div>

<div class="question-card compact-card" id="031-what-is-multi-agent-1">
...
<div class="question-card compact-card" id="031-what-is-multi-agent-2">
...
<div class="question-card compact-card" id="031-what-is-multi-agent-3">
...
<div class="question-card compact-card" id="032-communication-patterns-1">
...
<div class="question-card compact-card" id="032-communication-patterns-2">
...
<div class="question-card compact-card" id="032-communication-patterns-3">
...
<div class="question-card compact-card" id="033-orchestration-patterns-1">
...
<div class="question-card compact-card" id="033-orchestration-patterns-2">
...
<div class="question-card compact-card" id="033-orchestration-patterns-3">
...
<div class="question-card compact-card" id="034-task-allocation-coordination-1">
...
<div class="question-card compact-card" id="034-task-allocation-coordination-2">
...
<div class="question-card compact-card" id="034-task-allocation-coordination-3">
...
<div class="question-card compact-card" id="035-conflict-resolution-1">
...
<div class="question-card compact-card" id="035-conflict-resolution-2">
...
<div class="question-card compact-card" id="035-conflict-resolution-3">
...
<div class="question-card compact-card" id="036-multi-agent-frameworks-1">
...
<div class="question-card compact-card" id="036-multi-agent-frameworks-2">
...
<div class="question-card compact-card" id="036-multi-agent-frameworks-3">
...
<div class="question-card compact-card" id="037-agent-handoff-1">
...
<div class="question-card compact-card" id="037-agent-handoff-2">
...
<div class="question-card compact-card" id="037-agent-handoff-3">
...
<div class="question-card compact-card" id="038-emergent-behavior-1">
...
<div class="question-card compact-card" id="038-emergent-behavior-2">
...
<div class="question-card compact-card" id="038-emergent-behavior-3">
...
<div class="question-card compact-card" id="039-debugging-monitoring-multi-agent-1">
...
<div class="question-card compact-card" id="039-debugging-monitoring-multi-agent-2">
...
<div class="question-card compact-card" id="039-debugging-monitoring-multi-agent-3">
...
<div class="question-card compact-card" id="101-a2a-protocol-1">
...
<div class="question-card compact-card" id="101-a2a-protocol-2">
...
<div class="question-card compact-card" id="101-a2a-protocol-3">
