...
<div class="question-card custom-card" id="cot">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 什么是 CoT？为啥效果好？它有什么缺点或局限性？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：什么是 CoT？为啥效果好？它有什么缺点或局限性？</div>

<div class="question-prompt"><strong>题目</strong>：什么是 CoT？为啥效果好？它有什么缺点或局限性？</div>


<div class="q-conclusion">

💡 **15 秒结论**：CoT 我第一次用是在做一个需要多步逻辑推理的任务，发现只要让模型先分步分析，效果提升就很明显
...
<div class="question-card custom-card" id="decoding_strategies">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 大模型生成文本时的解码策略有哪些？贪心、Beam Search、采样分别什么时候…</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：大模型生成文本时的解码策略有哪些？贪心、Beam Searc</div>

<div class="question-prompt"><strong>题目</strong>：大模型生成文本时的解码策略有哪些？贪心、Beam Search、采样分别什么时候用？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解大模型的解码策略本质上是回答一个问题：模型在每一步输出了一个 vocabulary 大小的概率分布，我们怎么从中选下一个 token
...
<div class="question-card custom-card" id="deployment_frameworks">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 大模型部署有哪些主流方案？vLLM、TGI、llama.cpp、SGLang 实…</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：大模型部署有哪些主流方案？vLLM、TGI、llama.cp</div>

<div class="question-prompt"><strong>题目</strong>：大模型部署有哪些主流方案？vLLM、TGI、llama.cpp、SGLang 实际项目里怎么选？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解大模型部署框架的本质问题是：怎么在固定的硬件上跑得更快、更省显存、支持更多并发用户
...
<div class="question-card custom-card" id="dpo_vs_ppo">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 大模型的 DPO 和 PPO 的区别是什么？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：大模型的 DPO 和 PPO 的区别是什么？</div>

<div class="question-prompt"><strong>题目</strong>：大模型的 DPO 和 PPO 的区别是什么？</div>


<div class="q-conclusion">

💡 **15 秒结论**：DPO 和 PPO 都是大模型对齐训练里的方法，都是在 SFT 之后让模型的输出更符合人类期望
...
<div class="question-card custom-card" id="evaluation_metrics">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 大模型能力评测指标有哪些？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：大模型能力评测指标有哪些？</div>

<div class="question-prompt"><strong>题目</strong>：大模型能力评测指标有哪些？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我对这块的理解是，学术 Benchmark 只能作为参考，真正重要的是在自己业务数据上的表现
...
<div class="question-card custom-card" id="finetuning">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 大模型微调的方案有哪些？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：大模型微调的方案有哪些？</div>

<div class="question-prompt"><strong>题目</strong>：大模型微调的方案有哪些？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我了解微调之后，首先意识到的是：微调不是首选，而是最后手段
...
<div class="question-card custom-card" id="kv_cache_prompt_caching">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> KV Cache 是什么？Prompt Caching 的原理是什么？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：KV Cache 是什么？Prompt Caching 的原</div>

<div class="question-prompt"><strong>题目</strong>：KV Cache 是什么？Prompt Caching 的原理是什么？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解 KV Cache 和 Prompt Caching 是同一个机制在两个时间尺度上的应用
...
<div class="question-card custom-card" id="llm_training">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 大模型是怎么训练出来的？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：大模型是怎么训练出来的？</div>

<div class="question-prompt"><strong>题目</strong>：大模型是怎么训练出来的？</div>


<div class="q-conclusion">

💡 **15 秒结论**：大模型训练我理解是分三个阶段，每个阶段解决不同层次的问题
...
<div class="question-card custom-card" id="lora">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 请讲一下 LoRA 技术，除了减少参数量，它还有哪些优点？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：请讲一下 LoRA 技术，除了减少参数量，它还有哪些优点？</div>

<div class="question-prompt"><strong>题目</strong>：请讲一下 LoRA 技术，除了减少参数量，它还有哪些优点？</div>


<div class="q-conclusion">

💡 **15 秒结论**：LoRA 我在项目里用过，省参数这个优点大家都知道，但它还有几个很实用的好处
...
<div class="question-card custom-card" id="mha_mqa_gqa_flash_attention">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 多头注意力（MHA）有哪些局限？MQA、GQA、Flash Attention …</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：多头注意力（MHA）有哪些局限？MQA、GQA、Flash</div>

<div class="question-prompt"><strong>题目</strong>：多头注意力（MHA）有哪些局限？MQA、GQA、Flash Attention 怎么解决？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解 MHA 有三个核心痛点
...
<div class="question-card custom-card" id="model_selection">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 对比使用过哪些主流大模型？你们项目中最终选用了哪个模型？为什么？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：对比使用过哪些主流大模型？你们项目中最终选用了哪个模型？为什</div>

<div class="question-prompt"><strong>题目</strong>：对比使用过哪些主流大模型？你们项目中最终选用了哪个模型？为什么？</div>


<div class="q-conclusion">

💡 **15 秒结论**：在项目选型阶段，我会先把模型分成两类：一类是国内可落地的生产候选，比如 DeepSeek、Qwen、豆包这类模型；另一类是海外能力标杆，比如 GPT-5.5 / o 系列、Claude Sonnet / Opus 系列，用来做能力上限参照
...
<div class="question-card custom-card" id="moe">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> MoE 混合专家模型是什么？DeepSeek V3、Qwen 为什么用 MoE？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：MoE 混合专家模型是什么？DeepSeek V3、Qwen</div>

<div class="question-prompt"><strong>题目</strong>：MoE 混合专家模型是什么？DeepSeek V3、Qwen 为什么用 MoE？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解 MoE（Mixture of Experts，混合专家模型）的核心思想是把传统 Transformer 中的 FFN（前馈网络）层替换成 N 个并行的「专家网络」，再加一个 Router 来决定每个 token 进哪个专家
...
<div class="question-card custom-card" id="position_encoding">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 大模型的位置编码是干什么用的？sin/cos、RoPE、ALiBi 有什么区别？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：大模型的位置编码是干什么用的？sin/cos、RoPE、AL</div>

<div class="question-prompt"><strong>题目</strong>：大模型的位置编码是干什么用的？sin/cos、RoPE、ALiBi 有什么区别？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解位置编码要解决的问题，本质上是 Self-Attention 的「位置盲」缺陷
...
<div class="question-card custom-card" id="post_training">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> SFT 之后还有哪些 Post-Training？RLHF、DPO、GRPO、拒…</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：SFT 之后还有哪些 Post-Training？RLHF、</div>

<div class="question-prompt"><strong>题目</strong>：SFT 之后还有哪些 Post-Training？RLHF、DPO、GRPO、拒绝采样什么关系？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解 Post-Training 是个上位概念，指的是 SFT 之后所有继续提升模型质量的训练阶段
...
<div class="question-card custom-card" id="quantization">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 大模型量化是什么？INT8/INT4/AWQ/GPTQ 怎么选？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：大模型量化是什么？INT8/INT4/AWQ/GPTQ 怎么</div>

<div class="question-prompt"><strong>题目</strong>：大模型量化是什么？INT8/INT4/AWQ/GPTQ 怎么选？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解量化（Quantization）的本质是把模型参数从「高精度浮点数」（FP32 或 FP16）映射到「低精度整数」（INT8 或 INT4），用更少的比特表示同样的信息
...
<div class="question-card custom-card" id="scaling_law_emergence">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 什么是 Scaling Law？大模型的「涌现能力」是怎么回事？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：什么是 Scaling Law？大模型的「涌现能力」是怎么回</div>

<div class="question-prompt"><strong>题目</strong>：什么是 Scaling Law？大模型的「涌现能力」是怎么回事？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解 Scaling Law（缩放定律）讲的是大模型的损失值如何随模型规模、训练数据量、训练算力这三个量变化的可预测关系
...
<div class="question-card custom-card" id="temperature_top_p_top_k">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 大模型的参数：温度值、Top-P、Top-K 分别是什么？各个场景下的最佳设置是…</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：大模型的参数：温度值、Top-P、Top-K 分别是什么？各</div>

<div class="question-prompt"><strong>题目</strong>：大模型的参数：温度值、Top-P、Top-K 分别是什么？各个场景下的最佳设置是什么？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我调这几个参数的经验是，Temperature 是最关键的，另外两个基本不用动
...
<div class="question-card custom-card" id="tokenizer">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 什么是大模型项目的分词器？原理是什么？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：什么是大模型项目的分词器？原理是什么？</div>

<div class="question-prompt"><strong>题目</strong>：什么是大模型项目的分词器？原理是什么？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我觉得面试被问到 Tokenizer，最重要的是先说清楚「为什么需要它」，模型只能处理整数，不认识字符串，Tokenizer 就是把文字转成数字 ID 序列的桥梁
...
<div class="question-card custom-card" id="transformer_architecture">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 讲讲 Transformer 架构基本原理？Encoder 和 Decoder …</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：讲讲 Transformer 架构基本原理？Encoder</div>

<div class="question-prompt"><strong>题目</strong>：讲讲 Transformer 架构基本原理？Encoder 和 Decoder 是什么？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解 Transformer 最核心的创新是 Self-Attention，让每个 token 都能直接和序列里任意其他位置建立联系，一次性并行计算，彻底解决了 RNN 顺序计算慢、长距离信息衰减的两个老问题
...
<div class="question-card custom-card" id="what_is_llm">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 什么是大语言模型？和传统 NLP 模型有什么区别？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：LLM, 小林笔记 · 考察点：什么是大语言模型？和传统 NLP 模型有什么区别？</div>

<div class="question-prompt"><strong>题目</strong>：什么是大语言模型？和传统 NLP 模型有什么区别？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解大语言模型的本质，是一个用海量语料预训练、参数到百亿千亿规模、自回归生成文本的统一模型
