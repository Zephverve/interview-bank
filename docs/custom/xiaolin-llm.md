...
<p class="part-desc">Transformer · 微调 · 推理 · 部署 · 共 22 题</p>
...
<div class="question-card compact-card" id="prompt_engineering-1">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span><span class="question-text">任务</span></h2>
...
<div class="question-card compact-card" id="prompt_engineering-2">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span><span class="question-text">要求</span></h2>
...
<div class="question-card compact-card" id="prompt_engineering-3">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span><span class="question-text">文章内容</span></h2>
