...
<div class="question-card custom-card" id="advanced_paradigms">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 了解哪些更复杂的 RAG 范式？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：RAG, 小林笔记 · 考察点：了解哪些更复杂的 RAG 范式？</div>

<div class="question-prompt"><strong>题目</strong>：了解哪些更复杂的 RAG 范式？</div>


<div class="q-conclusion">

💡 **15 秒结论**：在我的了解里，RAG 的发展经历了三代演进：Naive RAG 是基础的检索加生成；Advanced RAG 在检索前后都加了优化，比如 Query 改写、Rerank、混合检索这些；Modular RAG 是把各个环节做成模块可以任意组合
...
<div class="question-card custom-card" id="dynamic_update">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> RAG 知识库如何实现动态与持续更新？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：RAG, 小林笔记 · 考察点：RAG 知识库如何实现动态与持续更新？</div>

<div class="question-prompt"><strong>题目</strong>：RAG 知识库如何实现动态与持续更新？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解知识库更新的核心挑战是，文档变了，对应的 chunk 和向量都要跟着变，而且要做到增量处理，不能每次全量重建
...
<div class="question-card custom-card" id="embedding">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 在 RAG 中 Embedding 究竟是什么？如何选择和评估一个 Embedd…</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：RAG, 小林笔记 · 考察点：在 RAG 中 Embedding 究竟是什么？如何选择和评</div>

<div class="question-prompt"><strong>题目</strong>：在 RAG 中 Embedding 究竟是什么？如何选择和评估一个 Embedding 模型？</div>


<div class="q-conclusion">

💡 **15 秒结论**：Embedding 我理解就是把一段文本转成一串数字向量的过程
...
<div class="question-card custom-card" id="embedding_algos">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> Embedding 有哪几种算法你了解过吗？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：RAG, 小林笔记 · 考察点：Embedding 有哪几种算法你了解过吗？</div>

<div class="question-prompt"><strong>题目</strong>：Embedding 有哪几种算法你了解过吗？</div>


<div class="q-conclusion">

💡 **15 秒结论**：Embedding 算法大致经历了三代演进
...
<div class="question-card custom-card" id="evaluation">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 怎么量化你的 RAG 效果？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：RAG, 小林笔记 · 考察点：怎么量化你的 RAG 效果？</div>

<div class="question-prompt"><strong>题目</strong>：怎么量化你的 RAG 效果？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我评估 RAG 效果是分两层来看的
...
<div class="question-card custom-card" id="graph_db">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 在什么场景下，你会选择使用图数据库来增强传统的向量检索？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：RAG, 小林笔记 · 考察点：在什么场景下，你会选择使用图数据库来增强传统的向量检索？</div>

<div class="question-prompt"><strong>题目</strong>：在什么场景下，你会选择使用图数据库来增强传统的向量检索？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我的判断是，当业务问题涉及多个实体之间的关联推理的时候，就需要考虑引入图数据库来增强
...
<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 如何规避 RAG 系统中大模型的幻觉？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：RAG, 小林笔记 · 考察点：如何规避 RAG 系统中大模型的幻觉？</div>

<div class="question-prompt"><strong>题目</strong>：如何规避 RAG 系统中大模型的幻觉？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我遇到过的 RAG 幻觉主要有两类
...
<div class="question-card custom-card" id="hardest_parts">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 在实际落地中，你觉得 RAG 最难的地方是哪里？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：RAG, 小林笔记 · 考察点：在实际落地中，你觉得 RAG 最难的地方是哪里？</div>

<div class="question-prompt"><strong>题目</strong>：在实际落地中，你觉得 RAG 最难的地方是哪里？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我觉得 RAG 最难的不是把它跑起来，一个基础的 Demo 一两天就能搭起来，难的是把它调好
...
<div class="question-card custom-card" id="multi_retrieval">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 什么是多路召回？具体怎么做？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：RAG, 小林笔记 · 考察点：什么是多路召回？具体怎么做？</div>

<div class="question-prompt"><strong>题目</strong>：什么是多路召回？具体怎么做？</div>


<div class="q-conclusion">

💡 **15 秒结论**：多路召回就是同时用多种不同的检索方式去捞候选内容，然后合并排序，而不是只靠单一的向量检索
...
<div class="question-card custom-card" id="online_workflow">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 你使用 RAG 给大模型一个输入，系统是怎样的工作流程？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：RAG, 小林笔记 · 考察点：你使用 RAG 给大模型一个输入，系统是怎样的工作流程？</div>

<div class="question-prompt"><strong>题目</strong>：你使用 RAG 给大模型一个输入，系统是怎样的工作流程？</div>


<div class="q-conclusion">

💡 **15 秒结论**：当你把一个问题输入给 RAG 系统，它不会直接丢给大模型，而是先经历一套「检索 -> 整理 -> 生成」的流水线
...
<div class="question-card custom-card" id="query_rewrite">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 如何润色用户的 Query（Query Rewrite）？目的是什么？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：RAG, 小林笔记 · 考察点：如何润色用户的 Query（Query Rewrite）？目</div>

<div class="question-prompt"><strong>题目</strong>：如何润色用户的 Query（Query Rewrite）？目的是什么？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我用 Query Rewrite 主要是为了弥补用户提问方式和知识库文档表述之间的语义鸿沟
...
<div class="question-card custom-card" id="rag_problems">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 大模型的 RAG 主要用来解决什么问题？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：RAG, 小林笔记 · 考察点：大模型的 RAG 主要用来解决什么问题？</div>

<div class="question-prompt"><strong>题目</strong>：大模型的 RAG 主要用来解决什么问题？</div>
...
<div class="question-card custom-card" id="rag_vs_finetune">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 相比直接微调 LLM，RAG 解决了什么问题？微调和 RAG 各自的优劣势是什么…</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：RAG, 小林笔记 · 考察点：相比直接微调 LLM，RAG 解决了什么问题？微调和 RAG</div>

<div class="question-prompt"><strong>题目</strong>：相比直接微调 LLM，RAG 解决了什么问题？微调和 RAG 各自的优劣势是什么？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我的理解是这两个东西解决的不是同一层面的问题，不是谁替代谁的关系
...
<div class="question-card custom-card" id="retrieval_opt">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> RAG 检索优化策略有哪些？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：RAG, 小林笔记 · 考察点：RAG 检索优化策略有哪些？</div>

<div class="question-prompt"><strong>题目</strong>：RAG 检索优化策略有哪些？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我理解 RAG 的检索优化可以从四个层次来看：索引层决定知识怎么存，查询层决定问题怎么转换，召回层决定从哪些路径去找，重排序层决定最终哪些内容进入 prompt
...
<div class="question-card custom-card" id="retrieval_types">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 请你介绍一下向量检索和关键词检索的区别？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：RAG, 小林笔记 · 考察点：请你介绍一下向量检索和关键词检索的区别？</div>

<div class="question-prompt"><strong>题目</strong>：请你介绍一下向量检索和关键词检索的区别？</div>


<div class="q-conclusion">

💡 **15 秒结论**：关键词检索（BM25 这类）靠的是词频统计，看查询词在文档里出现了多少次，擅长精确命中；向量检索靠的是语义空间里的距离，能理解「换了种表达方式的同一个意思」，擅长模糊语义匹配
...
<div class="question-card custom-card" id="semantic_cuts">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 怎么规避语义被切割掉的问题？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：RAG, 小林笔记 · 考察点：怎么规避语义被切割掉的问题？</div>

<div class="question-prompt"><strong>题目</strong>：怎么规避语义被切割掉的问题？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我的思路是从两个方向来规避这个问题
...
<div class="question-card custom-card" id="vectordb_practice">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 讲讲你用的向量数据库？数据量级是多大？性能如何？遇到过性能瓶颈吗？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：RAG, 小林笔记 · 考察点：讲讲你用的向量数据库？数据量级是多大？性能如何？遇到过性能瓶</div>

<div class="question-prompt"><strong>题目</strong>：讲讲你用的向量数据库？数据量级是多大？性能如何？遇到过性能瓶颈吗？</div>


<div class="q-conclusion">

💡 **15 秒结论**：我们生产环境用的是 Milvus，数据量级在百万条向量左右，每条是 1024 维，用 HNSW 索引，单次查询的延迟在 20 到 50 毫秒
...
<div class="question-card custom-card" id="whatisrag">

<h2 class="question-title"><span class="q-badge custom-badge">✦</span> 什么是 RAG？详细描述一个完整 RAG 系统的详细工作流程？</h2>

<div class="q-meta"><strong>轮次</strong>：一面/二面 · 难度：⭐⭐⭐ · 标签：RAG, 小林笔记 · 考察点：什么是 RAG？详细描述一个完整 RAG 系统的详细工作流程</div>

<div class="question-prompt"><strong>题目</strong>：什么是 RAG？详细描述一个完整 RAG 系统的详细工作流程？</div>


<div class="q-conclusion">

💡 **15 秒结论**：RAG 全称是 Retrieval-Augmented Generation，就是检索增强生成
