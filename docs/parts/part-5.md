...
<div class="question-prompt"><strong>题目</strong>：你简历里三个项目的时间线有重叠——2024.12 同时开始做科研问答系统和 DSTG-Net 的投稿，2026.05 又同时做 GenericAgent。你是怎么管理时间和精力的？</div>
...
<div class="question-prompt"><strong>题目</strong>：你的简历里写蓝桥杯 C++ 省二等奖三次、数学竞赛三等奖。但你的项目全是 Python。你的 C++ 和算法基础还在吗？</div>
...
💡 **15 秒结论**：蓝桥杯练的是 DS/算法思维，语言无关；Python 是 AI 生态效率选择，性能优化时能理解底层。
